// REDEVI Blockchain Server - MetaMask Fixed Version

const CHAIN_ID = 9983;
const CHAIN_ID_HEX = "0x" + CHAIN_ID.toString(16); // 0x26FF
...
async function handleRPC(req: Request): Promise<Response> {
  ...
  try {
    ...
    switch (method) {
      // ✅ FIXED: eth_chainId = Hex Format
      case "eth_chainId":
        result = CHAIN_ID_HEX;
        break;

      // ✅ FIXED: net_version = Decimal String
      case "net_version":
